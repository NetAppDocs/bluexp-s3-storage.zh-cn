...
+
https://docs.netapp.com/us-en/cloud-manager-sync/concept-cloud-sync.html["详细了解BlueXP复制和同步服务"^]。
...
+
https://docs.netapp.com/us-en/cloud-manager-data-sense/task-scanning-s3.html["了解有关BlueXP分类服务的更多信息"^]。
